...
// @updateURL    https://raw.githubusercontent.com/RiversGravity/6-nimmt-tracker/main/6-nimmt-script.meta.js
// @downloadURL  https://raw.githubusercontent.com/RiversGravity/6-nimmt-tracker/main/6-nimmt-script.js
...
(function () {
  ...
  // ---------- Build / constants ----------
  const BUILD_STAMP = '2025-01-12T17:30:00Z';
  ...
  function findGameDataObject() {
    if (typeof g_game !== 'undefined' && g_game.gamedatas) return g_game.gamedatas;
    if (typeof gameui !== 'undefined' && gameui.gamedatas) return gameui.gamedatas;
    if (typeof gamedatas !== 'undefined') return gamedatas;
    return null;
  }
